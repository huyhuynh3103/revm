...
## [5.0.0](https://github.com/huyhuynh3103/revm/compare/revm-primitives-v4.0.0...revm-primitives-v5.0.0) - 2024-06-14
...
### Fixed
- *(primitives)* specify the optimism cfg on spec_to_generic ([#1412](https://github.com/huyhuynh3103/revm/pull/1412))

### Other
- added simular to used-by ([#1521](https://github.com/huyhuynh3103/revm/pull/1521))
- derive PartialEq and Hash on EnvKzgSettings ([#1494](https://github.com/huyhuynh3103/revm/pull/1494))
